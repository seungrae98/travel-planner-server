...
public record ChatGPTPlanGetResponse(
    ...
    public static ChatGPTPlanGetResponse from(ChatGPTPlan chatGPTPlan) {
        return ChatGPTPlanGetResponse.builder()
                ...
                .travel_destination_1_local(chatGPTPlan.getTravel_destination_1_local())
                ...
                .travel_destination_2_local(chatGPTPlan.getTravel_destination_2_local())
                ...
                .travel_destination_3_local(chatGPTPlan.getTravel_destination_3_local())
                ...
                .restaurant_1_local(chatGPTPlan.getRestaurant_1_local())
                ...
                .restaurant_2_local(chatGPTPlan.getRestaurant_2_local())
                ...
                .restaurant_3_local(chatGPTPlan.getRestaurant_3_local())
